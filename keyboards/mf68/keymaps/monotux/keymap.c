...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SVORA5] = KEYMAP(NO_HALF, KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 , KC_F6 , KC_F7 , KC_F8 , KC_F9 ,KC_F10 ,KC_F11 ,KC_F12 ,KC_DEL ,KC_INS ,KC_VOLU,
                     _______,NO_LCBR,NO_RCBR,NO_LBRC,NO_RBRC,NO_DLR ,NO_QUO2,NO_QUES,NO_AMPR,NO_LESS,NO_GRTR,_______,_______,_______,KC_DEL ,KC_VOLD,
                     KC_CAPS,NO_SCLN,NO_SLSH,NO_LPRN,NO_RPRN,NO_PIPE,NO_HASH,NO_CIRC,NO_TILD,NO_QUOT,NO_GRV ,_______,_______,
                     _______,NO_COLN,NO_EQL , NO_AT ,NO_EXCL,NO_BSLS,NO_PERC,XXXXXXX,XXXXXXX,XXXXXXX,NO_ACUT,_______,KC_MUTE,
