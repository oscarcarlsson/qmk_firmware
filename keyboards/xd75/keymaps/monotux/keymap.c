...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_SV] = { /* SVORAK */
  ...
  { TG(3),   NO_AM,   NO_AE,   NO_OSLH, KC_P,    KC_Y,    KC_PGUP, KC_INS,  KC_HOME, KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    TG(2)   },
  ...
  { NO_APOS, KC_LEAD, MO(_MD), KC_LGUI, KC_LCTL, MO(_RS), KC_BSPC, KC_DOWN, KC_SPC,  MO(_LW), KC_LALT, KC_RGUI, KC_HYPR, KC_RCTL, NO_MINS },
 },
 ...
 [_LW] = { /* LOWERED */
  ...
  { ___T___, XXXXXXX, NO_EQL,  NO_AT,   KC_EXLM, NO_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, KC_PERC, NO_TILD, XXXXXXX, XXXXXXX, NO_ACUT, XXXXXXX  },
  { RESET,   XXXXXXX, ___T___, XXXXXXX, XXXXXXX, ___T___, XXXXXXX, XXXXXXX, XXXXXXX, ___T___, XXXXXXX, ___T___, XXXXXXX, XXXXXXX, XXXXXXX  },
 },
